...
export function generateCopilotBosunAgent(config: ProjectConfig): string {
  return `---
...
1. Run \`${config.runCommand}\` — if it fails, revert the fix and keep the item in the backlog
